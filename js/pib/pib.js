	...
	obj.html(
		'<div class="plupload_wrapper">' +
			'<div class="ui-widget-content plupload_container">' +
				...
				'</div>' +
*/
				'<div class="plupload_filelist plupload_filelist_header ui-widget-header">' +
				'<div>' +
					'<div class="plupload_cell plupload_file_name">' + _('Filename') + '</div>' +
					'<div class="plupload_cell plupload_file_status">' + _('Status') + '</div>' +
					'<div class="plupload_cell plupload_file_size">' + _('Size') + '</div>' +
					'<div class="plupload_cell plupload_file_action">&nbsp;</div>' +
				'</div>' +
				'</div>' +
				...
				'<div class="plupload_filelist plupload_filelist_footer ui-widget-header">' +
				'<div>' +
